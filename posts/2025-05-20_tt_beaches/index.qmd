...
city2 <- city +
  labs(title = "Water Quality Ratings at Sydney Beaches", 
       subtitle = "Sydney City ocean beaches, which are in the affulent Eastern Suburbs, are rated as Good for swimming \non at least 75% of testing days. \nIn Western Sydney, where swimming sites are creeks and rivers, only Penrith Beach is frequently safe to swim. \nWestern Sydney suburbs are frequently X degrees warmer than parts of the city closer to the ocean. The residents of the Western suburbs are in need of safe places to swim", x = "Sydney City Beaches")
...
west2 <- west +
  labs(title = "",
    caption = "Data from BeachWatch NSW 2020-2025", 
       subtitle = "", x = "Western Sydney Beaches")
...
ggsave(here::here("posts", "2025-05-20_tt_beaches", "test.png"), width = 10, height = 8,  bg = "white")
