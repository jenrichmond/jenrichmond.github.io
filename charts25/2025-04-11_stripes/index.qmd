...
temp <- read_csv(here("charts25", "2025-04-11_stripes", "daily-temperature-for-30-sites-to-2022-part2.csv"))
...
ggsave(here::here("charts25", "2025-03-31_challenge", "temp.png"), width = 8, height = 4,  bg = "white")
