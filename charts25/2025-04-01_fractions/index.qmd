...
willingness2024 %>%
  filter(entity != "World") %>%
  ggplot(aes(y =  prediction_others_willingness, x = self_willingness, colour = owid_region)) +
  geom_point() +
  scale_y_continuous(labels = percent_format(accuracy = 1, scale = 1), 
                      limits = c(0,100), expand = c(0,0), breaks = seq(0,100,20)) +
    scale_x_continuous(labels = percent_format(accuracy = 1, scale = 1), 
  ...
  ggrepel::geom_text_repel(aes(label = entity), size = 3, max.overlaps = 20)
...
plot <- willingness2024 %>%
  filter(entity != "World") %>%
  ggplot(aes(y =  prediction_others_willingness, x = self_willingness, 
             colour = owid_region, text = paste("country:", entity))) +
  geom_point() +
  scale_y_continuous(labels = percent_format(accuracy = 1, scale = 1), 
                      limits = c(0,100), expand = c(0,0), breaks = seq(0,100,20)) +
    scale_x_continuous(labels = percent_format(accuracy = 1, scale = 1), 
