...
vax <- read_csv(here("charts25/2025-04-25_risk/kindy_vax _rates.csv")) %>%
...
cases2425 <- read_csv(here("charts25/2025-04-25_risk/cases20242025.csv")) %>%
...
```{r}
#| include: false
ggsave(here::here("charts25", "2025-03-31_challenge", "measlesvax_continuous.png"), width = 6, height = 4,  bg = "white")
```
...
#| include: false
#| 
ggsave(here::here("charts25", "2025-03-31_challenge", "measlesvax_categorical.png"), width = 6, height = 4,  bg = "white")
...
ggsave(here::here("charts25", "2025-03-31_challenge", "measles.png"), width = 6, height = 4,  bg = "white")
