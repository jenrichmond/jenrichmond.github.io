...
age_use <- read_csv(here("charts25/2025-04-28_inclusion/age_group.csv")) %>%
...
age_sat <- read_csv(here("charts25/2025-04-28_inclusion/age_group.csv")) %>%
...
ggsave(here::here("charts25", "2025-03-31_challenge", "digital.png"), width = 6, height = 4,  bg = "white")
