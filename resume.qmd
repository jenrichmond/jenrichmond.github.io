...
[email](jennyrichmond@gmail.com)
[linkedin](https://www.linkedin.com/in/jenrichmondphd/)
[website](https://jenrichmond.github.io/)
:::
...
- Advanced R skills in data wrangling and visualisation (Tidyverse) and reproducible reporting (RMarkdown, Quarto)
...
- Built a comprehensive data skills curriculum covering data import, cleaning (dplyr), visualization (ggplot2), and communication (RMarkdown), published as an [open-source Quarto website](https://rladiessydney.org/courses/)
